...
%description -l pl
OpenDivX jest implementacj± MPEG-4 okre∂lonego w miÍdzynarodowej
normie ISO/IEC 14496-2.

%package devel
Summary:	Header files and development documentation for libdivxdecore
Summary(pl):	Pliki nag≥Ûwkowe i dokumentacja do libdivxdecore
...
Pliki nag≥Ûwkowe i dokumentacja do libdivxdecore.
